...
:root{--bg:#0a0c0f;--panel:#0f1216;--border:#1e2530;--border2:#2a3340;
      ...
      --orange:#ff6b35;--font-ui:'Rajdhani',sans-serif;--font-mono:'JetBrains Mono',monospace}
body{min-height:100vh;background:var(--bg);color:var(--text);font-family:var(--font-ui);
     display:flex;align-items:center;justify-content:center;padding:20px}
.card{background:var(--panel);border:1px solid var(--border);border-radius:6px;
      padding:40px;width:100%;max-width:380px}
.logo{font-size:28px;font-weight:700;letter-spacing:4px;text-transform:uppercase;
...
.subtitle{font-size:11px;color:var(--muted);letter-spacing:2px;text-transform:uppercase;
          text-align:center;font-family:var(--font-mono);margin-bottom:32px}
...
input[type=text],input[type=password]{width:100%;background:var(--bg);border:1px solid var(--border2);
  color:var(--text);padding:10px 14px;border-radius:4px;font-family:var(--font-ui);font-size:15px;
  font-weight:500;outline:none;transition:border-color .2s}
input:focus{border-color:var(--accent)}
.btn-login{width:100%;background:var(--accent);border:none;color:var(--bg);padding:12px;
           border-radius:4px;font-family:var(--font-ui);font-size:16px;font-weight:700;
           letter-spacing:2px;text-transform:uppercase;cursor:pointer;margin-top:8px;
           transition:opacity .2s}
.btn-login:hover{opacity:.85}
.error{background:#1a0808;border:1px solid var(--orange);color:var(--orange);
       padding:10px 14px;border-radius:4px;font-size:13px;margin-bottom:16px;font-family:var(--font-mono)}
...
<div class="card">
  ...
  <div class="subtitle">Pfadi Riko – Routenverfolgung</div>
